...
COMMON_CUDA_BLOCK_SIZES_POWERS_OF_2 = get_powers_of_2(16, MAX_CUDA_BLOCK_SIZE)

MAX_TRITON_BLOCK_SIZE = 65536
COMMON_TRITON_BLOCK_SIZES_POWERS_OF_2 = COMMON_CUDA_BLOCK_SIZES_POWERS_OF_2 + get_powers_of_2(
    2048, MAX_TRITON_BLOCK_SIZE
)
